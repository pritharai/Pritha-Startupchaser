  ...
  const learningItems = [
    {
      ...
      description: "Learn how to identify user pain points, define personas, and map out customer journeys just like product teams at top startups.",
    },
    {
      title: "Figma Mastery",
      description: "Design beautiful, consistent UI components and layouts. Work with auto-layout, variants, design systems, and collaborative prototyping.",
    },
    {
      title: " UX Flows & Interactions",
      description: "Design intuitive user flows, screen transitions, and micro-interactions to improve usability and engagement.",
    },
    {
      title: "Feedback & Iteration",
      description: "Test designs with users and teammates. Use feedback loops to rapidly iterate — just like real product teams.",
    },
    {
      title: "Handoff & Collaboration",
      description: "Work closely with developers using Figma inspect tools, style guides, and asset exports to ensure smooth handoff.",
    },
  ];
