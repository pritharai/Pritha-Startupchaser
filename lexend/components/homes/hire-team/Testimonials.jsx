  ...
  return (
    ...
    >
      <div className="section-outer panel py-4 md:py-6 xl:py-9">
        ...
        “Startup Chaser helped us identify and hire interns who were already trained on real startup use-cases. The portfolios gave us confidence, and the time-to-hire was cut in half. It's now our go-to platform for sourcing early-stage talent.”
      </p>
                      </div>
                      <div className="panel mt-2 lg:mt-4">
                        <div className="panel vstack items-center gap-0 lg:gap-1">
                          <h6 className="h6 lg:h5 m-0">Ravi Sharma</h6>
                          <span className="fs-7 lg:h6 opacity-70">
                            Talent Acquisition Lead, TechNova
                          </span>
                        </div>
                      </div>
                    </div>
