  ...
  const learningItems = [
    {
      ...
      description: "Master HTML, CSS, JavaScript, and frameworks like React to build responsive and interactive web interfaces.",
    },
    {
      title: "Backend Development ",
      description: "Learn Node.js, Express.js, RESTful APIs, and work with databases like MongoDB and MySQL to power your apps.",
    },
    {
      title: "Authentication & Security ",
      description: "Implement secure login/signup with JWT/OAuth, and protect your apps from common vulnerabilities.",
    },
    {
      title: "Version Control & Deployment",
      description: "Use Git, GitHub, and CI/CD workflows. Deploy full stack apps on platforms like Vercel, Render, and Railway.",
    },
    {
      title: "Real-Time Collaboration & Debugging",
      description: "Collaborate on real startup features, debug efficiently, and follow agile practices like GitHub projects and issue tracking.",
    },
  ];
