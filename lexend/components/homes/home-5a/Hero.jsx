...
>
  <h1 className="h2 sm:display-6 xl:display-4 fw-light mb-1 xl:mb-2">
    Hire a Team That Delivers Excellence.
  </h1>
  <p className="fs-6 xl:fs-4">
    From Product Manager to Fullstack, our handpicked team of top talent
    <br className="d-none lg:d-block" />
    is ready to build scalable, impactful solutions tailored to your needs.
  </p>
  ...
  <div className="vstack md:hstack justify-center lg:justify-start gap-2 mt-2 xl:mt-4 fdr">
    ...
    <div className="panel">
      ...
      <span className="fs-7 fw-medium">
        Trusted by 200+ partners globally
      </span>
    </div>
  </div>
</div>
