import { featureItems2, featureItems2_hire } from "@/data/features";
...
>
  ...
  <h2 className="h3 sm:h2 lg:h1 xl:display-6 m-0">
    Hire work-ready talent with proven skills
  </h2>
  <p className="fs-7 sm:fs-6 lg:fs-5 xl:fs-4 text-opacity-70">
    Access a pool of pre-vetted, project-ready candidates who’ve solved real industry problems under expert mentorship. Collaborate with us to find the right talent tailored to your company’s needs.
  </p>
</div>
            ...
            >
              {featureItems2_hire.map((item, index) => (
