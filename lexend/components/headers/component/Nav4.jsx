...
import { features_hire, homeLinks, links_hire } from "@/data/menu";
import { featuresMenu_hire, services } from "@/data/services";
          ...
          <div className="row child-cols-6 g-0 col-match">
            <div>
              <ul className="uc-nav uc-navbar-dropdown-nav p-2">
                {featuresMenu_hire.map((feature, index) => (
                  <li key={index}>
                    <Link
                ...
                <div className="vstack justify-between gap-2">
                  <div className="vstack gap-1">
                    ...
                    <p className="fs-7 opacity-70">
                       Hire from our growing base of project builders ready to take on real-world problems.
                    </p>
                  </div>
                  <Link
                    href={`/page-pricing`}
                  ...
                  >
                    ...
                    <span className="vstack gap-narrow mt-nnarrow">
                      ...
                      <span className="fw-normal">
                          See how companies are hiring builders directly from live project showcases.
                      </span>
                    </span>
                  </Link>
                </li>
                ...
                <li>
                  ...
                  >
                    ...
                    <span className="vstack gap-narrow mt-nnarrow">
                      ...
                      <span className="fw-normal">
                          Need a team? We help startups connect with talented contributors.
                      </span>
                    </span>
                  </Link>
                </li>
